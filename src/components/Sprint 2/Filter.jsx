...
//       if (response.ok) {
//         if (filterData.status === false && filterData.statusCode === 404) {
//           // No data found, set all state variables to null or false except setsearchJob
//           setsearchJob([]); // Pass an empty array to maintain the variable type
//           setcompanyList(null);
//           setJobData(null);
...
//           alert("No data found!");
//         } else {
//           // Data found, update state with filtered results
//           setData(filterData.data);
//           setsearchJob(filterData.data); // Pass the filtered data to searchJob
//           setcompanyList(null);
//           setJobData(null);
//           setFilteredData(filtered);
//           setComponent(true);
...
//         console.error("Failed to fetch filtered data:", filterData.message);
//       }
//     } catch (error) {
...
//   if (errorOne) {
//     return (
//       <p style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100vh', fontSize: '30px' }}>
//         Error: Server Not Responding
//       </p>
//     );
//   }
...
//         }
//         {searchJob && searchJob.length > 0 && <FilteredResults />}

//         {companyList && <FilteredResults />}
//         {companyList && companyList.length > 0 && <FilteredResults />}
...
//         {component && <FilteredResults />}
//         {(!searchJob || searchJob.length === 0) && <Typography>No data found</Typography>}
//         {searchJob && searchJob.length > 0 && <FilteredResults />}
//         {companyList && <FilteredResults />}
//         {companyList && companyList.length > 0 && <FilteredResults />}
//         {jobData && <FilteredResults />}
